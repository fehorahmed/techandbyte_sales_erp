...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/backend/files/bower_components/select2/dist/css/select2.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/backend/files/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">

    <link rel="stylesheet" href="{{ asset('themes/backend/files/bower_components/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/backend/files/assets/pages/data-table/css/buttons.dataTables.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/backend/files/assets/pages/data-table/extensions/buttons/css/buttons.dataTables.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/backend/files/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
    ...
    <style>
        ...
        @media only screen and (max-width: 576px) {
            .col-form-label.text-right,.col-form-check.text-right {
...
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/jquery/dist/jquery.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/jquery-ui/jquery-ui.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/bootstrap/dist/js/bootstrap.min.js') }}"></script>

<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/jquery-slimscroll/jquery.slimscroll.js') }}"></script>

<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/modernizr/modernizr.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/modernizr/feature-detects/css-scrollbars.js') }}"></script>

<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/chart.js/dist/Chart.js') }}"></script>
{{--jsTree--}}
...
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
...
<script src="{{ asset('themes/backend/files/bower_components/datatables.net-buttons/js/dataTables.buttons.min.js') }}"></script>
...
<script src="{{ asset('themes/backend/files/assets/pages/data-table/extensions/buttons/js/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('themes/backend/files/assets/pages/data-table/extensions/buttons/js/buttons.flash.min.js') }}"></script>
...
<script src="{{ asset('themes/backend/files/assets/pages/data-table/extensions/buttons/js/buttons.colVis.min.js') }}"></script>
<script src="{{ asset('themes/backend/files/bower_components/datatables.net-buttons/js/buttons.print.min.js') }}"></script>
<script src="{{ asset('themes/backend/files/bower_components/datatables.net-buttons/js/buttons.html5.min.js') }}"></script>
...
<script src="{{ asset('themes/backend/files/assets/pages/data-table/extensions/buttons/js/extension-btns-custom.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('themes/backend/files/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
