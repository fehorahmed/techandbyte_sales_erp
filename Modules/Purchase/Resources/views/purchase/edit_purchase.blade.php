        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('purchase.purchase_sent_inventory',['productPurchase'=>$productPurchase->id]) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row pb-3">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}"{{ old('supplier',$productPurchase->supplier_id) == $supplier->id ? 'selected' : '' }}>{{ $supplier->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('supplier')
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group batch_no ">
                                            <input type="text" class="form-control {{ $errors->has('batch_no') ? 'is-invalid' : 'is-valid' }}" name="batch_no" value="{{ old('batch_no') }}" placeholder="Batch No." required>
                                        </div>
                                        @error('batch_no')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group lc_no">
                                            <input type="text" class="form-control {{ $errors->has('lc_no') ? 'is-invalid' : 'is-valid' }}" name="lc_no" value="{{ old('lc_no',$productPurchase->lc_no) }}" placeholder="LC No.">
                                        </div>
                                        @error('lc_no')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right date-picker {{ $errors->has('date') ? 'is-invalid' : 'is-valid' }}" id="date" name="date" value="{{ empty(old('date')) ? ($productPurchase->date ?? date('d-m-Y')) : old('date') }}" autocomplete="off">
                                        </div>
                                        @error('date')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group purchase_details">
                                            <input type="text"
                                                   ...
                                                   name="purchase_details" value="{{ old('purchase_details',$productPurchase->purchase_details ?? '') }}"
                                                   autocomplete="off">
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    @if (old('product') != null && sizeof(old('product')) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        @if (count($productPurchase->products) > 0)
                                            @foreach ($productPurchase->products as $item)
                                                <tr class="product-item">
                                                    <td>
                                                        <div class="form-group product_area" style="min-width: 200px;">
                                                            <select class="form-control select2 product" style="width: 100%;" name="product[]">
                                                                ...
                                                                @if ($item->product_id)
                                                                    <option
                                                                        value="{{ $item->product_id }}" selected> {{ $item->product->product_name ?? '' }}
                                                                    </option>
                                                                @endif
                                                            </select>
                                                            <input type="hidden" name="product_name[]" class="product_name" value="{{$item->product->product_name ?? ''}}">
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group" style="min-width: 70px;">
                                                            <input type="text" step="any"
                                                                   class="form-control unit is-valid-border" name="unit[]" value="{{$item->product->unit->name ?? ''}}"
                                                                   readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" step="any" class="form-control quantity is-valid-border" name="quantity[]" value="{{$item->quantity}}">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group" style="min-width: 80px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="number" step="any" id="duty"
                                                                   class="form-control duty is-valid-border" name="duty" value="{{old('duty',$productPurchase->duty)}}">
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="number" step="any" id="freight"
                                                                   ...
                                                                   name="freight" value="{{old('freight',$productPurchase->freight)}}">
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="number" step="any" id="c_and_f"
                                                                   ...
                                                                   name="c_and_f" value="{{old('c_and_f',$productPurchase->c_and_f)}}">
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="number" step="any" id="at"
                                                                   class="form-control at is-valid-border" name="at" value="{{old('at',$productPurchase->at)}}">
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="number" step="any" id="etc"
                                                                   class="form-control etc is-valid-border" name="etc" value="{{old('etc',$productPurchase->etc)}}">
                                                        </th>
                                                    </tr>
                                                    <tr>
...
@section('script')
    <script>
        $(function() {
            ...
            $(document).on('input', '#paid', function() {
                ...
                let paid = $(this).val();
                let due = total - paid - previous_paid;
    ...
    <script>
        function calculate() {
            ...
            let due = parseFloat(grandTotal) - parseFloat(paid)- parseFloat(previous_paid);
            if (due < 0) {
