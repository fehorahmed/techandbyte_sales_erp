                ...
                <form method="POST" action="{{ route('sale.sale_add') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row pb-3">
                            ...
                            <div class="col-md-1">
                                <button type="button" id="add_new_customer_form" style="margin-top: 32px;padding: 0px 8px;font-size: 15px;margin-left: -15px;"><span style="font-weight: bold;">+</span></button>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Date</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group {{ $errors->has('paid') ? 'has-error' :'' }}">
                                                            <input type="text" style="border: 2px solid #2a28a7" class="form-control is-valid-border paid" name="paid" id="paid" required>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
...
@section('script')
    <script>
        $(function(){
            ...
            initSelect2();
            addProduct__delete();
            $('body').on('keyup', '.quantity, .product_rate,.discount_percent,.vat_percent,.product,#discount,.shipping_cost', function () {
                calculate();
            });
            $('body').on('change', '.quantity, .product_rate,.discount_percent,.vat_percent,.product,#discount,.shipping_cost', function () {
                calculate();
            });
