        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block mt-4">
                    <form id="main" method="post" action="{{ route('customer.customer_add') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' :'is-valid' }}" id="address" name="address" value="{{ old('address') }}" placeholder="Enter your address">{{old('address')}}</textarea>
                                @error('address')
                                   <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
