      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header table-card-header">
            ...
            <h5 style="float: right"><a href="{{ route('account.journal_voucher_add') }}" class="btn btn-success">Add Journal Voucher</a></h5>
          </div>
    ...
    <script>
        $(function () {
            $('#table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('account.journal_voucher_datatable') }}',
                columns: [
            ...
            $('body').on('click', '.btn-view', function () {
                ...
                if (accVoucherId != '') {
                    $.ajax({
                        method: "GET",
                        url: "{{ route('account.journal_voucher_view') }}",
