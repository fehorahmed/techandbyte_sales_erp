<?php
$menu = [
    'account.chart_of_account','account.sub_account_list','account.predefined_accounts','account.financial_year',
    'account.opening_balance','account.opening_balance_add','account.opening_balance_edit','account.debit_voucher','account.credit_voucher','account.contra_voucher','account.contra_voucher_add','account.contra_voucher_edit',
    'account.journal_voucher','account.journal_voucher_add','account.journal_voucher_edit','account.bank_reconciliation','account.add_payment_method','account.payment_method_list',
    'account.supplier_payment','account.customer_receive','account.service_payment','account.cash_adjustment',
    'account.voucher_approval','account.sub_account_all','account.sub_account_add','account.sub_account_edit',
    'account.financialyear_add','account.financialyear_all','account.financialyear_edit','account.debit_voucher_add','account.debit_voucher_edit','account.debit_voucher_view',
    'account.credit_voucher','account.credit_voucher_add','account.credit_voucher_edit','account.credit_voucher_view'
];
?>
...
<li class="pcoded-hasmenu {{ in_array(Route::currentRouteName(), $menu) ? 'active pcoded-trigger' : '' }}">
    ...
    <ul class="pcoded-submenu">
        ...
        <?php
        $subMenu = [
            'account.sub_account_all','account.sub_account_add','account.sub_account_edit'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
        ...
        <?php
        $subMenu = [
            'account.financialyear_add','account.financialyear_all','account.financialyear_edit'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
        ...
        <?php
        $subMenu = [
            'account.opening_balance','account.opening_balance_add','account.opening_balance_edit'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
        ...
        <?php
        $subMenu = [
            'account.debit_voucher','account.debit_voucher_add','account.debit_voucher_edit','account.debit_voucher_view'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
        ...
        <?php
        $subMenu = [
            'account.contra_voucher','account.contra_voucher_add','account.contra_voucher_edit'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
        ...
        <?php
        $subMenu = [
            'account.journal_voucher','account.journal_voucher_add','account.journal_voucher_edit'
        ];
        ?>
        <li class="{{ in_array(Route::currentRouteName(), $subMenu) ? 'active' : '' }}">
