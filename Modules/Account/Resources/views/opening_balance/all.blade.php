      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header table-card-header">
            ...
            <h5 style="float: right"><a href="{{ route('account.opening_balance_add') }}" class="btn btn-success">Add Opening Balance</a></h5>
          </div>
    ...
    <script>
        $(function () {
            $('#table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('account.opening_balance_datatable') }}',
                columns: [
