<div class="col-md-12" id="vaucherPrintArea">
    <div class="row p-b-20 voucher-center">
        ...
        <div class="col-md-6 text-center">
            ...
            <strong><u class="pt-4">Credit Voucher</u></strong>
        </div>
        <div class="col-md-3">
    ...
    <table class="table table-bordered table-sm mt-2">
        ...
        @if (!empty($accVoucher))
            @foreach ($accVoucher->details as $row)
                ...
                @endphp
                <tr>
                    <td><strong style="font-size: 15px;;"> {{ $row->account->HeadName ??'' }} ({{ $accVoucher->subType != 1? $accVoucher->sub_account->name: '' }})</strong><br>
