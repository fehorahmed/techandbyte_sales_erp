    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('account.credit_voucher_add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="voucher_type" class="col-sm-2 col-form-label">Voucher Type</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="voucher_type" value="Credit" readonly/>
                                @error('voucher_type')
