...
class ReportController extends Controller{
    public function purchase(Request $request) {
        ...
        return view('report::report.purchase', compact('orders', 'suppliers',
    ...
    public function sale(Request $request) {
        ...
        return view('report::report.sale', compact('customers', 'products',
            'appends', 'orders', 'suppliers','orderTotalAmount','orderPaidAmount','orderDueAmount','totalQuantity'));
    }
...
//        return($clientHistories);
        return view('report::report.party_ledger',compact('clients',
