            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block mt-4">
                        <form id="main" method="post" action="{{ route('client.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="client_category" class="form-control" id="client_category">
                                        ...
                                        @foreach ($client_categories as $client_category)
                                            <option {{ old('client_category') == $client_category->id ? 'selected' : '' }}
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : 'is-valid' }}" id="address" name="address"
                                        value="{{ old('address') }}" placeholder="Enter your address">{{ old('address') }}</textarea>
                                    @error('address')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
