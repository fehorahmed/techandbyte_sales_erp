                ...
                <div class="card">
                    ...
                    <div class="card-block mt-4">
                        <form id="main" method="post"
                            action="{{ route('product.product_edit', ['product' => $product->id]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text"
                                        ...
                                        name="name" value="{{ old('name', $product->product_name) }}" id="name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="sub_category" id="sub_category"
                                        class="form-control form-control-success {{ $errors->has('sub_category') ? 'is-invalid' : '' }}">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="sale_price"
                                        value="{{ old('sale_price', number_format($product->price, 2)) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control {{ $errors->has('product_details') ? 'is-invalid' : 'is-valid' }}" id="product_details"
                                        name="product_details" value="" placeholder="Enter your Product Details">{{ old('product_details', $product->product_details ?? '') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    @if ($product->image)
                                        <img width="100px" class="mt-2" src="{{ asset($product->image) }}"
                                            alt="">
                                    @endif
                                </div>
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="product_vat"
                                        value="{{ old('product_vat', $product->product_vat ?? '') }}"
    ...
    <script>
        $(function() {
            ...
            var subCategorySelected =
                '{{ empty(old('sub_category')) ? ($errors->has('sub_category') ? '' : $product->sub_category_id) : old('sub_category') }}';
