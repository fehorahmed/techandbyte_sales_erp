            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block mt-4">
                        <form id="main"  method="post" action="{{ route('product.product_add') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="sale_price" value="{{old('sale_price')}}" class="form-control {{ $errors->has('sale_price') ? 'is-invalid' :'is-valid' }}"  placeholder="0.00">
                                    @error('sale_price')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="sub_category" id="sub_category" class="form-control select2 form-control-success {{ $errors->has('sub_category') ? 'is-invalid' :'' }}">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="cost_price" value="{{old('cost_price')}}" class="form-control {{ $errors->has('cost_price') ? 'is-invalid' :'is-valid' }}"  placeholder="0.00">
                                    @error('cost_price')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <textarea class="form-control {{ $errors->has('product_details') ? 'is-invalid' :'is-valid' }}" id="product_details" name="product_details"  placeholder="Enter your Product Details">{{ old('product_details') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="product_vat" class="form-control {{ $errors->has('product_vat') ? 'is-invalid' :'is-valid' }}"  placeholder="Product VAT %">
                                    @error('product_vat')
                                    <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
