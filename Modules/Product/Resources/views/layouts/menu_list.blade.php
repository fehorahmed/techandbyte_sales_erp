<?php
$menu = [
    'product.unit_add','product.unit_all','product.unit_edit','product.category_add','product.category_all','product.category_edit',
    'product.sub_category_add','product.sub_category_all','product.sub_category_edit','product.product_add','product.product_all'
];
?>
