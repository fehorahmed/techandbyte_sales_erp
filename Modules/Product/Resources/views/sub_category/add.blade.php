            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block mt-4">
                        <form id="main" method="post" action="{{ route('product.sub_category_add') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control form-control-success select2 {{ $errors->has('category') ? 'is-invalid' :'' }}" name="category">
