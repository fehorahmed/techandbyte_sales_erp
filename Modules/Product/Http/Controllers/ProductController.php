...
class ProductController extends Controller{
    ...
    public function datatable(){
        $query = Product::with('supplierProduct');
    ...
    public function add(){
        ...
        return view('product::product.add',compact('categories','units','suppliers'));
    }
    ...
    public function edit(Product $product){
        ...
        return view('product::product.edit',compact('product','categories','units','suppliers'));
    }
    ...
    public function editPost(Product $product,Request $request){
        ...
        return redirect()->route('product.product_all')->with('message','Information edited');
    }
